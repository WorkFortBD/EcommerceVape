            ...
            <div className="container mx-auto p-5">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white p-4 rounded shadow-md">
                  ...
                  <div className="mt-2">
                    <OrderStatus status={orderDetails.payment_status} />
                  </div>

                  <h4 className="text-xl font-semibold mt-4">Delivery Status</h4>
                  <div className="mt-2">
                    <OrderStatus status={orderDetails.delivery_status} />
                  </div>
                </div>

                <div className="bg-white p-4 rounded shadow-md">
                  <div className='mb-4'>
                    <a className='bg-gray-200 hover:bg-gray-300 text-gray-700 py-2 px-4 rounded inline-block' target="_blank" href={`${process.env.REACT_APP_API_URL}invoice/${orderDetails.id}`}>
                      Download Invoice
                    </a>
                  </div>
