...
const ProductSingleMini = ({
  ...
  const redirectToProductDetailsPage = (product) => {
    router.push("/products/" + product.sku).then((_) => {
      window.scrollTo(0, 0);
    });
  };
                ...
                <Link href={uri}>
                  <a className="product-card-link">
                    <div style={{ overflow: "hidden" }}>
                      ...
                      <div
                        className="product-card-body-inner"
                        style={{
                          minHeight: "110px",
                          maxHeight: "110px",
                          display: "flex",
                      ...
                      >
                        ...
                        <span className="product-unit font-weight-500">
                          {item.per_unit_value}{" "}
              ...
              <>
                ...
                <div className="product-single-mini-cart">
                  <button
                    ...
                    className="simple-btn product-btn"
                  >
        ...
        <div className="product-card-body">
            ...
            <a className="product-card-link">
              <div style={{ overflow: "hidden" }}>
                ...
                >
                  ...
                  <span className="product-unit font-weight-500">
                    {item.per_unit_value} {item.unit_name && item.unit_name}
                  </span>
                  <p
                    className={`stock-status ${
                      parseInt(item.current_stock) > 0
          ...
          <div className="product-single-mini-cart">
            <button
              type="button"
              onClick={() => addToCart(item)}
              className="simple-btn homepage-product-btn"
            >
              <div className="simple-btn__inner">
                <div className="simple-btn__icon">
                  <i className="fas fa-shopping-bag"></i>
