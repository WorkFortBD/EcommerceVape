...
export const createOrder = (customerInfo, carts, totalQuantity, shippingCost, totalPrice, couponData, userData) => (dispatch) => {
  ...
  const orderPostedData = {
      ...
      shipping_details: customerInfo.address, // @todo No needs, remove when fixed api
      order_quantity  : totalQuantity,
      shipping_charges: shippingCost,
      additional_notes: customerInfo.ordernotes??null,
      staff_note      : '',
      paid_total      : 0,
      ...
      customer_location  : customerInfo.address,
