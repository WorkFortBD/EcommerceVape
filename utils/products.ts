...
/**
 * Check if product has an actual offer or not.
 *
 * This will calculate if item offer price is less than default selling price
 *
 * @return boolean
 */
export function productHasOffer(default_selling_price: number, offer_selling_price: number, isOfferEnable: boolean) {
